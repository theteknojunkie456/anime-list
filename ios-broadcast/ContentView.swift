...
struct ContentView: View {
    @State private var name = AppGroup.partyName == "Guest" ? "" : AppGroup.partyName
    @State private var code = AppGroup.partyCode
    @State private var joined = !AppGroup.partyCode.isEmpty
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("🎉 WatchList Party").font(.title2.bold())
